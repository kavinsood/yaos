...
s.check(SCHEMA_VERSION === 10, "document schema is 10");
s.check(STORAGE_FORMAT_VERSION === 6, "storage format is 6");
s.check(PROTOCOL_VERSION === 8, "socket protocol is 8");
...
s.check(emitted.schemaVersion === 10 && emitted.storageFormatVersion === 6
	&& emitted.protocolVersion === 8 && emitted.snapshotFormatVersion === 4,
...
s.check(embedded.schemaVersion === 10 && embedded.storageFormatVersion === 6
	&& embedded.protocolVersion === 8 && embedded.snapshotFormatVersion === 4,
