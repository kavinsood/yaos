...
if (schemaVersion !== 8 || storageFormatVersion !== 3 || protocolVersion !== 4 || snapshotFormatVersion !== 3) {
	throw new Error("server product versions must remain schema 8 / storage 3 / protocol 4 / snapshot 3");
}
