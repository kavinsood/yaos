...
if (schemaVersion !== 7 || storageFormatVersion !== 3 || protocolVersion !== 4 || snapshotFormatVersion !== 2) {
	throw new Error("server product versions must remain schema 7 / storage 3 / protocol 4 / snapshot 2");
}
