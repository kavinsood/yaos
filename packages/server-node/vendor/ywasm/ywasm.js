...
exports.YSubdocsEvent = YSubdocsEvent;
...
exports.YTransaction = YTransaction;
...
exports.YUndoManager = YUndoManager;
...
exports.YWeakLinkEvent = YWeakLinkEvent;
...
exports.YXmlTextEvent = YXmlTextEvent;
 ...
 * @param {any} _origin
 */
function applyAwarenessUpdate(awareness, update, _origin) {
 ...
 * @returns {boolean}
 */
function applyUpdateAndCheckIfChanged(doc, update, origin) {
    _assertClass(doc, YDoc);
    const ret = wasm.applyUpdateAndCheckIfChanged(doc.__wbg_ptr, update, origin);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] !== 0;
}
exports.applyUpdateAndCheckIfChanged = applyUpdateAndCheckIfChanged;
 ...
 * @param {any} origin
 */
function applyUpdateV2(doc, update, origin) {
    _assertClass(doc, YDoc);
 ...
 * @returns {Uint8Array}
 */
function applyUpdatesV1(gc, updates) {
...
exports.applyUpdatesV1 = applyUpdatesV1;
 ...
 * @returns {Uint8Array}
 */
function applyUpdatesV2(gc, updates) {
    const ptr0 = passArrayJsValueToWasm0(updates, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
...
exports.applyUpdatesV2 = applyUpdatesV2;
 ...
 * @returns {boolean}
 */
function compareRelativePositions(a, b) {
 ...
 * @returns {any}
 */
function createAbsolutePositionFromRelativePosition(rpos, doc) {
    _assertClass(doc, YDoc);
 ...
 * @returns {any}
 */
function createRelativePositionFromTypeIndex(ytype, index, assoc, txn) {
...
exports.debugUpdateV1 = debugUpdateV1;
...
exports.debugUpdateV2 = debugUpdateV2;
 ...
 * @returns {any}
 */
function decodeRelativePosition(bin) {
 ...
 * @returns {any}
 */
function decodeSnapshotV1(snapshot) {
...
exports.decodeSnapshotV1 = decodeSnapshotV1;

/**
 * @param {Uint8Array} snapshot
 * @returns {any}
 */
function decodeSnapshotV2(snapshot) {
    const ptr0 = passArray8ToWasm0(snapshot, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
function encodeRelativePosition(rpos) {
 ...
 * @returns {Uint8Array}
 */
function encodeSnapshotV1(snapshot) {
    const ret = wasm.encodeSnapshotV1(snapshot);
    var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
    return v1;
}
exports.encodeSnapshotV1 = encodeSnapshotV1;

/**
 * @param {any} snapshot
 * @returns {Uint8Array}
 */
function encodeSnapshotV2(snapshot) {
 ...
 * @returns {Uint8Array}
 */
function encodeStateAsUpdate(doc, vector) {
    _assertClass(doc, YDoc);
 ...
 * @returns {Uint8Array}
 */
function encodeStateAsUpdateV2(doc, vector) {
    _assertClass(doc, YDoc);
 ...
 * @returns {Uint8Array}
 */
function encodeStateFromSnapshotV1(doc, snapshot) {
    _assertClass(doc, YDoc);
...
exports.encodeStateFromSnapshotV1 = encodeStateFromSnapshotV1;
 ...
 * @returns {Uint8Array}
 */
function encodeStateFromSnapshotV2(doc, snapshot) {
    _assertClass(doc, YDoc);
...
exports.encodeStateFromSnapshotV2 = encodeStateFromSnapshotV2;
 ...
 * @returns {boolean}
 */
function equalSnapshots(snap1, snap2) {
 ...
 * @returns {Uint8Array}
 */
function mergeUpdatesV1(updates) {
...
exports.mergeUpdatesV1 = mergeUpdatesV1;
 ...
 * @returns {Uint8Array}
 */
function mergeUpdatesV2(updates) {
 ...
 * @returns {Uint8Array}
 */
function modifyAwarenessUpdate(update, modify) {
 ...
 */
function removeAwarenessStates(awareness, clients) {
    _assertClass(awareness, Awareness);
...
const wasmPath = `${__dirname}/ywasm_bg.wasm`;
